...
#define HP 2 // 1=Front FHP(BLUE), 2=Top THP(RED), 3=Rear RHP(GREEN)
...
void setup(){
  ...
  if (HP==1) {TinyWireS.begin(0x19);twitchLEDTime = 1000;blueON(5);} // Start I2C Bus SLAVE I2C Address 25/0x19 (Assigned FHP)
  if (HP==2) {TinyWireS.begin(0x1a);twitchLEDTime = 2300;redON(5);}  // Start I2C Bus SLAVE I2C Address 26/0x1a (Assigned THP)
  if (HP==3) {TinyWireS.begin(0x1b);twitchLEDTime = 1900;greenON(5);}// Start I2C Bus SLAVE I2C Address 27/0x1b (Assigned RHP)
...
void twitchLED() {
     randomLEDFX = random (1,5);    // Pick a number 1 - 7
     switch (randomLEDFX) {
      case 1:
       whiteON(0);
       break;
